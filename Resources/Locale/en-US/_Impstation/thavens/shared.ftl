...
thaven-mood-thaven-only-crew-desc = You believe that CentComm is not accommodating enough of Thaven needs. An effort should be made to fight for better rights and protections under Space Law.
