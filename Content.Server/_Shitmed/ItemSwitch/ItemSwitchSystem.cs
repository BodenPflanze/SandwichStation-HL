...
public sealed class ItemSwitchSystem : SharedItemSwitchSystem
{
    ...
    public override void Initialize()
    {
        ...
        // Sandwich-HL change
        // SubscribeLocalEvent<ItemSwitchComponent, MeleeHitEvent>(OnMeleeAttack, after: [typeof(SharedStaminaSystem)]);    // Goob Stamina System- we dont have that here
        SubscribeLocalEvent<ItemSwitchComponent, MeleeHitEvent>(OnMeleeAttack);                                             // using this to replace it for now
        // Sandwich-HL  Change end
    }
